...
public class Constants {
    ...
    public static final String KEYDATABUNDLE = "K1";
    public static final String KEYEXAMPLEINTVALUE = "K2";
    public static final String KEYEXAMPLELONGVALUE = "K3";
    public static final String KEYEINHEITEN = "K4";
    public static final String KEYKTEINTRAG = "K5" ;
    public static final String KEYGERICHT = "K6";
    public static final String KEYNAHRUNGSMITTEL = "K6" ;
    public static final String KEYCURRENTEINHEIT = "K7";
